...
import {ERC20, ERC20Capped} from "../external/@openzeppelin/contracts/token/ERC20/extensions/ERC20Capped.sol";
import {AccessControlEnumerable} from "../external/@openzeppelin/contracts/access/AccessControlEnumerable.sol";

contract TizzFinanceToken is ERC20Capped, AccessControlEnumerable {
    ...
    constructor(
        address admin
    ) ERC20Capped(100_000_000e18) ERC20("Tizz Finance Token", "TFT") {
