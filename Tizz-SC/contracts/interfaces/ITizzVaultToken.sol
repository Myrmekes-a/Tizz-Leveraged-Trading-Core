...
interface ITizzVaultToken {
    ...
    event MaxTizzSupplyMintDailyPUpdated(uint256 newValue);
    ...
    event Depleted(address indexed sender, uint256 assets, uint256 amountTizz);
    event Refilled(address indexed sender, uint256 assets, uint256 amountTizz);
    ...
    error WrongValue();
    error WrongValues();
    error TizzPriceCallFailed();
    error TizzTokenPriceZero();
