...
import { fetchCurrentPriceFeeds } from './libs/fetchSupraFeeds';
import { logger } from './utils/logger';

const main = async () => {
  logger.info('  Price feed sync service is running');
  logger.info('  Price data path is %s', path.join(__dirname, '../../logs'));
