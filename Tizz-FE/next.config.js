...
const getSecurityHeaders = () => {
  ...
  headers["Content-Security-Policy"] =
    ...
    "connect-src 'self' https://worldtimeapi.org/api/ip https://tizz-be-api-sepolia-production.up.railway.app https://arbitrum-sepolia.blockpi.network/v1/rpc/public wss://tizz-be-api-sepolia-production.up.railway.app wss://relay.walletconnect.org wss://relay.walletconnect.com https://tizz-prediction-be-production.up.railway.app wss://tizz-prediction-be-production.up.railway.app/graphql https://walletconnect.com https://walletconnect.org wss://www.walletlink.org https://verify.walletconnect.com https://tizz-guild-be-production-1cf6.up.railway.app https://verify.walletconnect.org https://explorer-api.walletconnect.com https://api.ipify.org; " +
    "font-src 'self'; " +
    "object-src 'none'; " +
