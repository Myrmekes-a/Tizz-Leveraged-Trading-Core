...
import { collateralTokenIcons, tizzContractAddresses } from "@/utils/tizz";
...
export default function PortfolioStatePanel({
  ...
  const stateItems = [
    {
      title: t("vault"),
      icon: <ValutIcon size={14} width={32} height={32} fill="#F4CD8C" />,
      leftCom: (
    ...
    {
      title: t("referrals"),
      icon: <UsersIcon size={32} width={32} height={32} fill="#F4CD8C" />,
      leftCom: (
        <div className="flex items-center gap-2 text-3xl font-semibold text-white">
          0
          <TokenIcon
    ...
    {
      title: t("rewards"),
      icon: <AwardIcon size={24} width={32} height={32} fill="#F4CD8C" />,
      leftCom: (
