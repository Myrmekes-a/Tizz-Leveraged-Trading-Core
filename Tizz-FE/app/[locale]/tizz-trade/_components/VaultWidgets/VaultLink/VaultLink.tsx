    ...
    <Link href={`/tizz-trade/vault/${collateralType}`}>
      <BaseCard classNames={{ base: "p-6 bg-neutral-900 gap-2" }}>
        <div className="flex items-center gap-2">
          ...
          <span className="rounded border border-emerald-500/20 bg-emerald-400/30 px-2 py-[1px] text-sm font-bold text-emerald-400">
            {apy !== null ? `${getPercentageStr(apy * 100)}% APY` : "... APY"}
          </span>
        </div>
