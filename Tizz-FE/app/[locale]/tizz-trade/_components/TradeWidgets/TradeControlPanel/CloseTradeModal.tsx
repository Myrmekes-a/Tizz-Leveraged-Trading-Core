...
import { Fee, Pair, CollateralTypes } from "@tizz-hive/sdk";
...
import { tizzContractAddresses, collateralPairIds } from "@/utils/tizz";
...
export default function CloseTradeModal({
  ...
  const handleConfirm = async () => {
    ...
    if (!pair || pair.pairId === null || pair.pairId === undefined) {
      return;
    }
