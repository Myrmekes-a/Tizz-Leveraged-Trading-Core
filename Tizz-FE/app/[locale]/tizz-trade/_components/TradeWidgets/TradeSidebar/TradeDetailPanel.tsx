...
import { Fee, Pair, PositionType, CollateralTypes } from "@tizz-hive/sdk";
...
export default function TradeDetailPanel({
  ...
  const cachedLPData = useDelayedUpdate(lpData, lpStatus);
  ...
  const liquidationPriceValue =
    cachedLPData !== undefined ? getPriceStr(Number(cachedLPData) / 1e10) : "-";
