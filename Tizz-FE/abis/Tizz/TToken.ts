export const TTokenAbi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        ...
        indexed: false,
        internalType: "struct IVaultToken.LockedDeposit",
        name: "d",
        type: "tuple",
      },
    ],
    ...
    inputs: [
      {
        ...
        indexed: false,
        internalType: "struct IVaultToken.TizzPriceProvider",
        name: "newValue",
        type: "tuple",
      },
    ],
    name: "TizzPriceProviderUpdated",
    type: "event",
  },
  {
    anonymous: false,
    ...
    inputs: [
      {
        ...
        internalType: "struct IVaultToken.DeployParam",
        name: "_deployParam",
        type: "tuple",
      },
      {
        components: [
          ...
          },
          {
            ...
            internalType: "struct IVaultToken.TizzPriceProvider",
            name: "tizzPriceProvider",
            type: "tuple",
          },
        ],
        internalType: "struct IVaultToken.ContractAddresses",
  ...
  {
    inputs: [],
    name: "tizzProtocolTokenToAssetsPrice",
    outputs: [
      {
        internalType: "uint256",
        name: "price",
  ...
  },
  {
    ...
    name: "updateMaxTizzSupplyMintDailyP",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
